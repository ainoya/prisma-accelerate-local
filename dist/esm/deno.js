...
import { PrismaAccelerate, ResultError } from './prisma-accelerate.js';
export const importModule = (name, metaUrl) => {
...
export const createHandler = ({ adapter, queryEngineWasmModule, secret, runtime, }) => {
